...
def update_worksheet(data, worksheet):
    """
    reviews a list of integers to be insertd into a worksheet 
    updat the relevant worksheet with the data provided
    """
...
def calculate_surplus_data(sales_row):
    ...
    The surplus is different as the sales figure subtracted from the stock:
...
def get_last_5_entries_sales():
    """
    Collects collums of data from sales worksheets, collecting 
